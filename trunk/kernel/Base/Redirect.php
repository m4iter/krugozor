...
class Base_Redirect
{
    ...
    public function run()
    {
        ...
        {
            $db = Base_Registry::getInstance()->objects->db;
	        ...
	        $this->redirect_url = $this->redirect_url.'notif='.$db->getLastInsertId();
        }
    ...
    public function findById($id)
    {
        ...
        if ($data = $res->fetch_assoc())
        {
            ...
            $db->query('DELETE FROM `notifications` WHERE `id_notification` = ?i', $this->id_notification);
        }
    }
}
?>