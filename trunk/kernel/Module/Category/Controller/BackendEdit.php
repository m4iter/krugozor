...
class Module_Category_Controller_BackendEdit extends Module_Category_Controller_BackendCommon
{
    public function run()
    {
        ...
        {
            $this->category = self::getMapper('Category/Category')->createNew();
        ...
        $this->getView()->tree = self::getMapper('Category/Category')->findCategoriesByActive();
    ...
    {
        $this->category = self::getMapper('Category/Category')->createFromCover($this->getRequest()->getPost('category'));
        ...
        {
            self::getMapper('Category/Category')->save($this->category);
