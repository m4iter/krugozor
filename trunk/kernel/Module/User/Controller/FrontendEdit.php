    ...
    protected function post()
    {
        ...
        (
            ...
            array('login', 'first_name', 'phone', 'mail', 'url', 'icq',
                  'country', 'region', 'city', 'age_day', 'age_month', 'age_year', 'id')
        );
        ...
        {
            $validator->add('login', new Module_User_Validator_UserLoginExists($this->user->getLogin(), $this->user->getId()));
        }
        ...
        {
            $validator->add('mail', new Module_User_Validator_UserMailExists($this->user->getMail()->getValue(), $this->user->getId()));
        }
        ...
        else
        {
            ...
            if ($this->user->getPassword())
            {
                ...
                $user = self::getMapper('User/User')->findByLoginPassword($this->user->getLogin(), $this->getRequest()->getRequest()->user->password_1);
