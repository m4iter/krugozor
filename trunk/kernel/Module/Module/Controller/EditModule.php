...
class Module_Module_Controller_EditModule extends Module_Module_Controller_CommonModule
{
    public function run()
    {
        ...
        {
            $this->module = self::getMapper('Module/Module')->createNew();
        }
        else
        {
            $this->module->loadControllers();
        }
    ...
    {
        $this->module = self::getMapper('Module/Module')->createFromCover(
        ...
        {
            $validator->add('name', new Module_Module_Validator_ModuleNameExists($this->module->getName(),
                                                                                 $this->module->getId()));
        }

        if ($this->module->getKey())
        {
            $validator->add('key', new Module_Module_Validator_ModuleKeyExists($this->module->getKey(),
                                                                               $this->module->getId()));
        }
        ...
        {
            self::getMapper('Module/Module')->save($this->module);
