<?php
/*
Установка параметров подключения по умолчанию:
...
class Db_Mysql_Base
{
    ...
    */
    ...
    /**
     * Возвращает ссылку на ресурс соединения.
     *
     * @access public
     * @param void
     * @return resource
    ...
    /**
     * Устанавливает новую БД $ndb.
     *
     * @access public
     * @param string $ndb имя базы данных
     * @return void
     */
    public function setCurrentDb($ndb)
    {
        ...
        {
            throw new Db_Mysql_Exception('Невозможно выбрать базу данных', mysql_error());
        }
    }
    ...
    */
    public function query()
    {
        ...
        if (!$this->result)
        {
            throw new Db_Mysql_Exception('Ошибка в запросе', mysql_error(), $this->query);
        }
