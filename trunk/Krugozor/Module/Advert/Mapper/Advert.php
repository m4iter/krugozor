...
class Module_Advert_Mapper_Advert extends Module_Common_Mapper_Common
{
    ...
    public function findListForBackend($params)
    {
        ...
        return parent::result2objects(call_user_func_array(array($this->db, 'query'), $params['args']));
    }
    ...
    public function findListForIndex($num=10)
    {
        ...
        return parent::result2objects(call_user_func_array(array($this->db, 'query'), array($sql, $num)));
    }
    ...
    public function findListForUser($id_user, $start, $stop)
    {
        ...
        return parent::result2objects(call_user_func_array(array($this->db, 'query'), array($sql, $id_user, $start, $stop)));
    }
    ...
    public function findByIdUrl($id, $category_url)
    {
        ...
        $objects = parent::result2objects($this->db->query($sql, $id, $category_url));
