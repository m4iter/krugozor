...
class Module_Advert_Controller_FrontendCategoryList extends Module_Advert_Controller_FrontendCommon
{
    public function run()
    {
        ...
        $category = $this->getMapper('Category/Category')->findByUrl($this->getRequest()->getRequest('category_url'));
        ...
        $subcategories = $this->getMapper('Category/Category')->loadLevel($category->getId(), $params);
        ...
        $this->getView()->adverts = $this->getMapper('Advert/Advert')->findListForCatalog($params);
