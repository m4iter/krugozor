...
class Module_User_Mapper_User extends Module_Common_Mapper_Common
{
    ...
    public function updateActualInfo($user)
    {
        return $this->db->query('
            ...
            SET
                ...
                `user_ip` = "?s"
            WHERE
                `id` = ?i', $_SERVER['REMOTE_ADDR'], $user->getId());
    }
     ...
     *
     * @param Module_Group_Model_Group
     * @return bool
     */
    public function setDefaultGroupForUsersWithGroup(Module_Group_Model_Group $group)
    {
        return $this->db->query('
	        UPDATE
	            `' . $this->db_table_name . '`
