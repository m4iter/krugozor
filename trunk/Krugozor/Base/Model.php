...
abstract class Base_Model extends Cover_Abstract_Simple
{
    ...
    /**
     * @param Mapper_Manager $mapperManager
     */
    public function setMapperManager(Mapper_Manager $mapperManager)
    {
     ...
     * @return string|null имя get- или set- метода
     */
    ...
    public function __call($method_name, $argument)
    {
        ...
        switch ($action)
        {
            ...
            case 'set':
                ...
                // return $has_errors; - закоментировал 7 февраля
                return $this;
        }
    }
